     ...
     void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
           // Debug.Log("Click Works");
            RaycastHit2D hit = Physics2D.Raycast(Camera.main.ScreenToWorldPoint(Input.mousePosition), Vector3.zero); // Somewhere in this line or something before it causes the issue
            if (hit)
            {
